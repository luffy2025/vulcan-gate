...
require (
	...
	github.com/go-kratos/kratos/contrib/log/zap/v2 v2.0.0-20250307161706-982270e9576b // indirect
...
replace github.com/vulcan-frame/vulcan-pkg-tool => ./pkg/tool/vulcan-pkg-tool
replace github.com/vulcan-frame/vulcan-pkg-app => ./pkg/app/vulcan-pkg-app
